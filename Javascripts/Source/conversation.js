...
function startQuestionsOnly(txt, clr, doc)
{
	...
	doc.write('<p class="gblock" style="padding-top:0;padding-bottom:0;margin-bottom:-6px;margin-top:-4px;font-size:medium;' + clr +'"><b>' + txt + '</b></p>');
...
function addOptionLink(doc, lnk, js, pclass, sty, id)
{
	...
	var nv = true;
	if (pclass === undefined) {
		if (lnk.indexOf("walk ") != -1 || lnk.indexOf("exit ") != -1 || lnk.indexOf("return ") != -1 || lnk.indexOf("leave ") != -1 || lnk.indexOf("visit ") != -1 || lnk.indexOf("follow ") != -1 /*|| lnk.indexOf("go to ") != -1*/)	pclass = "moveblock";
	...
	if (nv && pclass != "moveblock" && doc !== "ss" && doc !== "string") {
	...
	if (pclass == "moveblock") lnk = "<img draggable='false' src='UI/walk.png' style='height:10px;height:0.8em' alt='walk'> " + lnk;
	var adj = '';
	var st = '';
