...
function getVersion() { return "14.10beta4"; }
...
function endMain(doc)
{
	...
	doc.write('<p style="font-size:0.5em;margin-top:0;margin-bottom:0">&nbsp;</p><div id="fadeblack" class="black_overlay" style="display:none"></div>');
}
...
function isScreenSmall() { return gameState.nWidth < gameState.nHeight; }
