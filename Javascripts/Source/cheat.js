...
function ChangePersonLst(md)
{
	...
	if (per.uid == "amyross") {
		...
		s += ' : <a class="black" href="javascript:findPerson(\'MissLogan\').unCharmThem();ChangePersonLst(document)">Uncharmed</a> or ' +
				  '<a class="black" href="javascript:findPerson(\'MissLogan\').charmThem(1);ChangePersonLst(document)">Charmed</a> or ' +
...
function writePersonDetails()
{
	...
	var cw;
	if (gameState.nRightBarState == 2 || gameState.bInventoryPopup) {
		cw = gameState.nLeftBarState == 2 ? "100vw - 45px" : "91vw - 20px";
		//cw = gameState.nLeftBarState == 2 ? "100vw - 70px" : "91vw - 45px";
	} else if (gameState.nRightBarState == 1) {
		cw = gameState.nLeftBarState == 2 ? "100vw - 45px" : "91vw - 20px";
		//cw = gameState.nLeftBarState == 2 ? "85vw - 45px" : "76vw - 20px";
	} else if (gameState.nRightBarState > 2) {
		cw = gameState.nLeftBarState == 2 ? "100vw - 45px" : "91vw - 20px";
		//cw = gameState.nLeftBarState == 2 ? "75vw - 45px" : "66vw - 20px";
	}
	...
	md.write(
		'</select></td><td style="width:80%"><table style="color:black">' +
