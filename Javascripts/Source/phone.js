...
function getPhoneContents()
{
	...
	if (stype == "notes1" || stype == "notes2" || stype == "notes3" || stype == "notes4") s = getPhoneNotes(stype);  // Notes		
	else if (stype === "" || stype === undefined || stype == "alarm" || stype == "sms" || stype == "clear" || stype == "delete" || stype == "addressbook" || stype == "apps" || stype == "game" || stype == "games") {
