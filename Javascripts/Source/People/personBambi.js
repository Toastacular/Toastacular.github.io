	...
	per.showEventPopup = function()
	{
		...
		if (Place == 124 && this.dress === "") {
			showPopupWindow("Where is the person in charge",
				...
				addOptionLink("string", 'the slim figure', "findPerson('Bambi').dress='Kiki';bPopupShown=false;dispPlace(124,'','As you approach you see the other your woman leave, she must of been a customer. It sounds like she is leaving the hotel and Glenvale')", "chatblock", "width:30%;margin-left:10%") +
				addOptionLink("string", 'the full figure', "findPerson('Bambi').dress='Jessica';bPopupShown=false;dispPlace(124,'','As you approach you see the other your woman leave, she must of been a customer. It sounds like she is leaving the hotel and Glenvale')", "chatblock", "width:30%;margin-left:10%"),
				'', '', true, true, true
			);
			return true;
		}
		...
		// Futa reaction
		if (Place == 182 && !this.checkFlag(18) && perYou.isFuta() && !perYou.isBornMale()) {
			this.setFlag(18);
