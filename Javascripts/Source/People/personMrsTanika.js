...
function initialiseMrsTanika()
{
	...
	per.getPersonInfo = function() {
		switch(this.getCharmedLevel()) {
			case 0:
				// Un-charmed
				return this.addPersonString("tanika1a.jpg", "height:max%", "right") +
			...
			case 2:
				// Lover
				return this.addPersonString("tanika10.jpg", "height:max%", "right") +
					"Mrs. Tanika, your math teacher, and now lover. She is still strict and stand-offish to others, but she is your lover now!";

			case 3:
				// Fuck toy
				return this.addPersonString("tanika12b.jpg", "height:max%", "right") +
	...
	per.showEvent = function()
	{
		...
		if (sType == "tanikaxxx") {
			...
			if (clv < 3) {
				...
				if (!perYou.isMaleSex() || (perYou.isMaleSex() && isExplicit())) addLinkToPlaceO(md, 'Have your slave orally service you', Place, 'type=tanikabj');
			} else {
			...
			if (!isDay() && !bSchool) {
				...
				addPopupLinkC(md, "take " + mtn + " to bed for the night", "Bedding " + tn,
					'<img src="Images/People/MrsTanika/' + (clv == 3 ? 'tanika14b' : 'tanika14a') + '.jpg" style="position:absolute;width:100%;bottom:0" alt="Tanika"></p>' +
		...
		if (sType == "tanikafuck" || sType == "tanikabj") {
			...
			if (sType == "tanikafuck") {
				...
				if (perYou.isMaleSex()) {
					...
					this.showPersonRandomRorX("tanika8g", isExplicit() ? 4 : 2);
				}
		...
		if (sType == "charmmrstanika2") {
			...
			if (type === "help") {
				md.write(
					'Mrs. Tanika is a little confused by the magic coursing through her,</p>' +
				...
				md.write(
					'You have had enough of her attitude, she is a disciplinarian who enjoys punishing her students. You firmly tell her "No" you will not leave the room and you slap her while focusing on the spell and reciting it again. She staggers, but the slap was not that hard, she moans as the magic rushes through her more and more. You tell her,</p>' +
		...
		if (sType == "charmmrstanika3") {
			...
			type = getQueryParam("ctype");
			md = WritePlaceHeader(false, type == "help" ? "" : "td-left-large");
			...
			if (type === "help") {
				this.charmThem(2);
				md.write(
					'You tell Mrs. Tanika that really what she is feeling is her love and desire for you and how much she must want you above and instead of <i>anyone</i> else,</p>' +
				...
				this.charmThem(4);
				md.write(
					'You tell her that she is your slave, who is utterly obsessed with you and will do absolutely anything for you. No-one and nothing else matters anymore in her life!</p>' +
					'<p>"You are my ' + perYou.getMaster() + ', my husband is nothing to me now and you are everything to me. Please take me!</p>');
			} else {
				this.charmThem(3);
				if (perYou.isMaleSex()) {
					md.write(
						'You tell her she is a cock-ornament, a cum-dump, a slut who&apos;s purpose is to provide you sexual pleasure! You tell her she will always be aroused and ready for your cock. To your surprise she smiles,</p>' +
						'<p>"I am your fuck-toy, my past life, my husband means nothing. Fuck me!</p>');
				} else {
					md.write(
						'You tell her she is a lesbian toy, a slut who&apos;s purpose is to make you orgasm with tongue, fingers or body. You tell her she will always be aroused and ready for your strap-on or to lick you when ordered. A look of defiance passes over her face,</p>' +
		...
		if (sType == "charmmrstanika4") {
			...
			if (type == "take" || type == "fuck") {
				...
				this.showPersonRandomRorX(bMan ? "tanika9b" : "tanika9g", bMan ? (isExplicit() ? 4 : 1) : 2);
			}
