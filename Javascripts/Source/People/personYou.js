	...
	perYou.showEventPopup = function()
	{
		if (Place == 1 && nFromPlace != 1) {
			showPopupWindow("",
				...
				"If you find any mistakes or have ideas of your own then join the <a href='http://hypnopics-collective.net/index.php' target='_top'>Hypnopics Collective Forums</a> and join the discussion.<br><br>" +
