	...
	per.showEvent = function()
	{
		...
		if (Place == 269 && gameState.bLastSex && !this.checkFlag(20)) {
			...
			md.write(
				...
				'<p>She must of been aroused by your last visitor, and you see she seems to be wearing a white bikini, then again what other colour would a ghost wear? She poses for you sexily but she starts to fade back into vapour, so this visit was more a tease than anything else...</p>'
			);
			startQuestionsOnly();
