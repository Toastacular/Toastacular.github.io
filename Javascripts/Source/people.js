...
function Person(nm, plc, fldrin, drs, dance)
{
	...
	this.isHere = function() { return this.whereNow() == Place || this.whereNow() == -1; };
	...
	// Retuen the state of the item in this persons inventory. NO existance test or range checking
	...
	this.isFuta = function() { return this.getPersonGender() == "futa"; };		// Are they a futa
