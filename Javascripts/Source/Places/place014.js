...
function ShowPlace14(stype)
{
	...
	startQuestions();
	 if ((bMurder && (getHour() > 7 && getHour() < 10)) || (!bMurder && getHour() < 8 || getHour() > 13)) addLinkToPlace(md, "leave the office", 15, '', '<img src="Images/limo.jpg" style="width:20%;float:right;margin-left:5px;margin-bottom:1em">Shortly after you leave you see the garage door open and the limo drive out. ' + nm + ' must of been called out to drive someone. You will have to return in a few hours if you wish to see her again');
