...
function ShowPlace374()
{
	...
	if (perJesse.whereNow() == 6) {
		...
		if (clvT > 0 && isCharmedBy("Mom") && !checkPersonFlag("Mom", 33) && plcTracy == 374) {
			...
			img = "tv" + (plcTracy == 374 ? "1" : Math.random() < 0.5 ? "2" : "3") + ".jpg";
			if (plcTracy != 374) msg = 'You spend some time catching up on the news on TV, although not the station you would watch with Mom around.';
