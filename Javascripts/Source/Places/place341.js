...
function ShowPlace341()
{
	...
	if (perJesse.getDemonPath() < 20) addQuestionCO(md, 'kiss her', "Kurndorf", -14420);
		...
		addPopupLink(md, 'try and stop her', "Demon",
			...
			'"No!" she hisses, locking her eyes on you as they begin to pulse red with hate.<br><br>' +
			'"You shall face us soon enough, <i>mortal</i>," she says, yanking her arm from you and escaping out into the town.',
